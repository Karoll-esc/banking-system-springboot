...
class CuentaBancariaControllerTest {
        ...
        void setUp() {
                ...
                createCuentaBancariaDTO = CreateCuentaBancariaDTO.builder()
                                ...
                                .saldoActual(new BigDecimal("1000.00")).usuarioId(1L).build();

                cuentaBancariaDTO =
                                CuentaBancariaDTO.builder().id(1L).numeroCuenta("1234567890123456")
        ...
        void consultarSaldo_ConCuentaInexistente_DeberiaRetornar404() throws Exception {
                ...
                when(cuentaBancariaService.consultarSaldo(cuentaIdInexistente)).thenThrow(
                                new CuentaBancariaNotFoundException(cuentaIdInexistente));
                ...
                mockMvc.perform(get("/cuentas/{cuentaId}/saldo", cuentaIdInexistente)
                                ...
                                .andExpect(jsonPath("$.message")
                                                .value("Cuenta bancaria con ID 999 no encontrada"));
